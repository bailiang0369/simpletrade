"""Fast Targeted High-Confidence Models (LGBM & XGBoost) for Event Options.
"""
...
def train_eval_stoch_fast(dataset_path: str, horizon_str: str):
    print(f"\n=======================================================")
...
if __name__ == "__main__":
    p15, y15, ts15 = train_eval_stoch_fast("data/datasets/ds_ETH_stoch_h15.parquet", "H15m")
    p30, y30, ts30 = train_eval_stoch_fast("data/datasets/ds_ETH_stoch_h30.parquet", "H30m")
